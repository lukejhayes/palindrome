...
//Get prompted and check that sentence
var userString = prompt('What string do you want to test for palindromes?');

palindromeDetector(userString);

// Uncomment the sentence you want to test
// palindromeDetector(sentence1);
// palindromeDetector(sentence2);
// palindromeDetector(sentence3);
